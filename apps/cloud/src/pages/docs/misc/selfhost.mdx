...
Information on selfhosting Cloud Env

Depending on your requirements you may wish to selfhost Cloud Env, this documentation covers setup and possible configuration options for a self hosted enviroment. In the future a docker image will be provided to make this process easier

## Basic Setup

To setup a base install for Cloud Env:
1. Clone the repo
2. Run `yarn install`
